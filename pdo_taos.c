...
PHP_MINIT_FUNCTION(pdo_taos)
{
    ...
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOS_VARCHAR",  (zend_long)(TSDB_DATA_TYPE_VARCHAR + 6000));
    ...
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOS_VARBINARY",  (zend_long)(TSDB_DATA_TYPE_VARBINARY + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOS_DECIMAL",  (zend_long)(TSDB_DATA_TYPE_DECIMAL + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOS_BLOB",  (zend_long)(TSDB_DATA_TYPE_BLOB + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOS_MEDIUMBLOB",  (zend_long)(TSDB_DATA_TYPE_MEDIUMBLOB + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOS_BINARY",  (zend_long)(TSDB_DATA_TYPE_BINARY + 6000));
    REGISTER_PDO_CLASS_CONST_LONG("PARAM_TAOS_MAX",  (zend_long)(TSDB_DATA_TYPE_MAX + 6000));
